      ...
      <div className="rp-window-body rp-janela-mdi__corpo rp-dash rp-cockpit rp-rolagem">
        ...
        <div className="rp-dash-row">
          ...
          <Cartao
            ...
            nota={
              <>
                <span className="rp-link" role="link" tabIndex={0} aria-label="Abrir dados da empresa" onClick={() => win.open('company-profile')} onKeyDown={(e) => e.key === 'Enter' && win.open('company-profile')} /> Complete em Configurações → Dados da empresa.
              </>
            }
          />
        </div>
